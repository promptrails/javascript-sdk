...
import type { InstallMCPTemplateRequest, ListParams, MCPTemplate, MCPTool } from "../types";

import { BaseResource } from "./base";

export class MCPTemplatesResource extends BaseResource {
  async list(params?: ListParams & { category?: string }): Promise<PaginatedResponse<MCPTemplate>> {
  ...
  async install(slug: string, data: InstallMCPTemplateRequest): Promise<MCPTool> {
